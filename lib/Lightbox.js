	...
	_createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			if (isVideo) {
				return _react2.default.createElement(
					'video',
					{ style: { cursor: onClickImage ? 'pointer' : 'auto', maxHeight: 'calc(100vh - ' + heightOffset + ')', maxWidth: '100%' }, controls: true, autoPlay: true, className: (0, _aphrodite.css)(this.classes.video) },
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('img', {
						className: (0, _aphrodite.css)(this.classes.image, this.classes.imageLoaded),
